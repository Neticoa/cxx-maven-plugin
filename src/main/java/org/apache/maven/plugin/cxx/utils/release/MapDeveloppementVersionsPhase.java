 ...
 * @author 
 */
public class MapDeveloppementVersionsPhase
    extends CxxAbstractReleasePhase
{
        ...
        throws MojoExecutionException, MojoFailureException
    {
        ...
        logInfo( result, "TODO rewrite from MapVersionsPhase with respect to version and autoVersionSubmodules parameters" );
