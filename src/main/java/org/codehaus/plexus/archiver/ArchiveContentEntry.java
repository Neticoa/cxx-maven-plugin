...
{
    public static final String ROLE = ArchiveContentEntry.class.getName();
     ...
     */
    private ArchiveContentEntry( String name, /*@Nonnull*/ PlexusIoResource resource, int type, int mode/*,
    ...
    */
    ...
    {
        return new ArchiveContentEntry( target, resource, FILE, permissions );
    }
    /*
    ...
    */
    public static ArchiveContentEntry createDirectoryEntry( String target, PlexusIoResource resource, int permissions )
    {
        return new ArchiveContentEntry( target, resource, DIRECTORY, permissions );
    }
    ...
    */
    public static ArchiveContentEntry createSymlinkEntry( String target, PlexusIoResource resource, int permissions )
    {
        return new ArchiveContentEntry( target, resource, SYMLINK, permissions );
    }
    /*
